...
class ddARToolkitPlus  {
	...
	void getMultiMarkerTranslationAndOrientation(dhVector &translation, dhMat &orientation);
	...
	dhVector getDetectedMarkerCenter(int markerIndex);
	...
	void getDetectedMarkerCorners(int markerIndex, vector<dhVector> &corners);
	/* Adds the four corners of the detected marker in screen coordinates to the passed in vector.
	 * The corners are ordered consistantly, starting in the top left and going around in a clockwise direction. */
	void getDetectedMarkerOrderedCorners(int markerIndex, vector<dhVector> &corners);
	/* Adds the four corners of the detected marker border in screen coordinates to the passed in vector */
	void getDetectedMarkerBorderCorners(int markerIndex, vector<dhVector> &corners);
	/* Adds the four corners of the detected marker border in screen coordinates to the passed in vector.
	 * The corners are ordered consistantly, starting in the top left and going around in a clockwise direction. */
	void getDetectedMarkerOrderedBorderCorners(int markerIndex, vector<dhVector> &corners);
...
protected:
	...
	void findHomography(vector<dhVector> src, vector<dhVector> dst, float homography[16]){
	...
	dhMat findHomography(vector<dhVector> src, vector<dhVector> dst)
	{
		float homography[16];
